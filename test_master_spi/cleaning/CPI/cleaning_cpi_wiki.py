...
Sao Tome and Principe 56 | Sã¯ Tomé ¡nd Prï¿½ipe
...
Congo Republic	56 | Republic of the Congo
Czech Republic	56 | Czechia
Sao Tome and Principe 56 | São Tomé and Príncipe
North Macedonia	56 | FYR Macedonia
Eswatini 56 | Swaziland
"""

cpi5 = pd.read_csv(path_cleaning +"/CPI/Corruption_Perceptions_Index_5.csv")    
cpi4 = pd.read_csv(path_cleaning +"/CPI/Corruption_Perceptions_Index_4.csv")
cpi3 = pd.read_csv(path_cleaning +"/CPI/Corruption_Perceptions_Index_3.csv")
cpi2 = pd.read_csv(path_cleaning +"/CPI/Corruption_Perceptions_Index_2.csv")

    
cpi_10 = pd.read_csv(path_cleaning +"/CPI/CPI_2010.csv")
cpi_11 = pd.read_csv(path_cleaning +"/CPI/CPI_2011.csv")
...
cpi_long.to_csv(path_cleaning + 'CPI//CPI_Index.csv')
