...
# load data
polity_orig = pd.read_excel(path_cleaning + '/Polity/p5v2018.xls')
...
"""
dropped_countries = ["Serbia and Montenegro",
"Yemen North",
...
Add years 1990, 1991 and 1992 for Czech Republic and Slovakia
Use values from Czechoslovakia for them:
    - double rows for Czechoslovakia and rename them to CZ and SL
Use values from Yugoslavia for B&H

Eritrea: 1990 and 1991: Years of Eritrean War of Independence; will add 0 for anarchy

"Transitions (-88) following a year of independence, interruption (-66),
or interregnum (-77) are prorated from the value 0"
"""
# Save data as .csv
polity_year95.to_csv(path_cleaning + "/Polity/polity95.csv", index=False) 
