...
science_orig = pd.read_excel(path_cleaning + '/Science/scimagojr country rank 1996-2022.xlsx')
...
science["Foreign relevance"] = (science["Citations"] - science["Self-citations"] )/ ((sum(science["Citations"]) - sum(science["Self-citations"]))*100)
...
science_score.to_csv(path_cleaning + "/Science/science_score.csv", index=False)
